namespace BMS
{
	partial class frmSonCDDetails
	{
		...
		{
			System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(frmSonCDDetails));
			...
			this.Name = "frmSonCDDetails";
			this.Text = "CHI TIẾT CÔNG ĐOẠN SƠN";
