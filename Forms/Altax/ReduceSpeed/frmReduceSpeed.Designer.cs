namespace BMS
{
	partial class frmReduceSpeed
	{
		...
		{
			System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(frmReduceSpeed));
			...
			this.colTimeTeaching.Width = 105;
			// 
			// colTimeGetVongQuay
			// 
			...
			this.colTimeGetVongQuay.Width = 155;
			// 
			// colTimeStop
			// 
			...
			this.colTimeStop.AppearanceCell.TextOptions.VAlignment = DevExpress.Utils.VertAlignment.Center;
			this.colTimeStop.AppearanceCell.TextOptions.WordWrap = DevExpress.Utils.WordWrap.Wrap;
			this.colTimeStop.AppearanceHeader.Font = new System.Drawing.Font("Tahoma", 8.25F, System.Drawing.FontStyle.Bold);
			this.colTimeStop.AppearanceHeader.Options.UseFont = true;
			...
			this.colTimeStop.AppearanceHeader.TextOptions.VAlignment = DevExpress.Utils.VertAlignment.Center;
			this.colTimeStop.AppearanceHeader.TextOptions.WordWrap = DevExpress.Utils.WordWrap.Wrap;
			this.colTimeStop.Caption = "Thời gian dừng ";
			this.colTimeStop.FieldName = "TimeStop";
			this.colTimeStop.Name = "colTimeStop";
			this.colTimeStop.Width = 101;
			// 
			// colCreateDate
			// 
