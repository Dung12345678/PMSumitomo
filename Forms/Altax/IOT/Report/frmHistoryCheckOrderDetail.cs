...
namespace BMS
{
	public partial class frmHistoryCheckOrderDetail : _Forms
	{
		public string _QRCode;
		public DateTime _DateLR;
		public string _OrderCode;
		public frmHistoryCheckOrderDetail()
		{
			InitializeComponent();
		}

		private void frmHistoryCheckOrderDetail_Load(object sender, EventArgs e)
		{
			loadData();
		}
		void loadData()
