namespace BMS
{
    partial class frmProductGroupDetail
    {
        ...
        {
			System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(frmProductGroupDetail));
			...
			this.btnSave.Tag = "frmProduct_AddGroup";
			...
			this.btnNew.Tag = "frmProduct_AddGroup";
			...
			this.btnEdit.Tag = "frmProduct_AddGroup";
			...
			this.btnDelete.Tag = "frmProduct_AddGroup";
			...
			this.FormClosed += new System.Windows.Forms.FormClosedEventHandler(this.frmProductGroupDetail_FormClosed);
