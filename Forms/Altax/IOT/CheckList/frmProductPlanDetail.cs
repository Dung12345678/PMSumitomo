...
namespace BMS
{
	public partial class frmProductPlanDetail : _Forms
	{

		private bool _isAdd;
		public ProductionPlanModel ProductionPlan = new ProductionPlanModel();

		public frmProductPlanDetail()
		{
			InitializeComponent();
		}
		...
		bool saveData()
		{
			...
			ProductionPlan.Prints = checkPrint.Checked;
		...
		void loadData()
		{
			...
			checkPrint.Checked = ProductionPlan.Prints;
		}
