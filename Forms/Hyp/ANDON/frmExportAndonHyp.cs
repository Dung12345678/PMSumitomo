...
namespace BMS
{
	public partial class frmExportAndonHyp : _Forms
	{
		public frmExportAndonHyp()
		{
			InitializeComponent();
		}
		...
		private void exportExcel()
		{
			try
			{
				...
				Workbook wb = xlApp.Workbooks.Open(sampleFile + @"\Data ANDON Hyp assy line.xlsx");
