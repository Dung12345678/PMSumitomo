namespace BMS
{
	partial class frmReduceSpeedDetailH
	{
		/// <summary>
		...
		private void InitializeComponent()
		{
			...
			System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(frmReduceSpeedDetailH));
			...
			this.NTimeGetVongQuay = new System.Windows.Forms.NumericUpDown();
			...
			((System.ComponentModel.ISupportInitialize)(this.NTimeGetVongQuay)).BeginInit();
			...
			this.mnuMenu.Size = new System.Drawing.Size(703, 44);
			...
			this.NMin.Location = new System.Drawing.Point(565, 56);
			...
			this.txtStandValue.Location = new System.Drawing.Point(204, 95);
			...
			this.label10.Location = new System.Drawing.Point(511, 128);
			...
			this.label7.Text = "Thời gian chạy 1 chiều";
			// 
			// label5
			// 
			...
			this.txtName.Location = new System.Drawing.Point(204, 58);
			...
			this.label1.Text = "Thời gian lấy dữ liệu vòng quay";
			// 
			// NMax
			// 
			this.NMax.DecimalPlaces = 2;
			this.NMax.Location = new System.Drawing.Point(565, 93);
			...
			this.NTimeRunF.Location = new System.Drawing.Point(204, 168);
			...
			this.NTimeRunF.TabIndex = 6;
			// 
			// NTimeGetVongQuay
			// 
			this.NTimeGetVongQuay.DecimalPlaces = 2;
			this.NTimeGetVongQuay.Location = new System.Drawing.Point(204, 127);
			this.NTimeGetVongQuay.Maximum = new decimal(new int[] {
            1569325055,
            23283064,
            0,
            0});
			this.NTimeGetVongQuay.Minimum = new decimal(new int[] {
            -1981284353,
            -1966660860,
            0,
            -2147483648});
			this.NTimeGetVongQuay.Name = "NTimeGetVongQuay";
			this.NTimeGetVongQuay.Size = new System.Drawing.Size(120, 22);
			this.NTimeGetVongQuay.TabIndex = 5;
			// 
			// NudTimeTeaching
			// 
			this.NudTimeTeaching.DecimalPlaces = 2;
			this.NudTimeTeaching.Location = new System.Drawing.Point(204, 210);
			...
			this.Controls.Add(this.NTimeGetVongQuay);
			...
			this.Name = "frmReduceSpeedDetailH";
			...
			((System.ComponentModel.ISupportInitialize)(this.NTimeGetVongQuay)).EndInit();
		...
		private System.Windows.Forms.NumericUpDown NTimeGetVongQuay;
