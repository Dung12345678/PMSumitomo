...
namespace BMS
{
    public partial class frmProductH : _Forms
    {
        int _curentNode = 0;
        int _catID = 0;
        ...
        {
            frmProductGroupDetailH frm = new frmProductGroupDetailH();
        ...
        {
            int id = TextUtils.ToInt(treeData.FocusedNode.GetValue(colIDTree));
            frmProductDetailH frm = new frmProductDetailH();
        ...
        {
            //Load các dụng cụ theo nhóm đag focus
            try
            {
                int id = TextUtils.ToInt(treeData.FocusedNode.GetValue(colIDTree));
                if (id > 0)
        ...
        {
            frmProductWorkingH frm = new frmProductWorkingH();
        ...
        {
            frmImportProductExcelH frm = new frmImportProductExcelH();
            frm.Show();
        }
        private void btnSungLuc_Click(object sender, EventArgs e)
        {
            frmProductForceGunH frm = new frmProductForceGunH();
            frm.Show();
        }
		...
		{
            frmReduceSpeedH frm = new frmReduceSpeedH();
            frm.Show();
        }
	}
}
