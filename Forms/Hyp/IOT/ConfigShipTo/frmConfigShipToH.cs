...
namespace BMS
{
	public partial class frmConfigShipToH : _Forms
	{
		public frmConfigShipToH()
		{
			InitializeComponent();
		}
		...
		void LoadData()
		{
			DataTable dt = LibIE.Select("select * from ConfigShipTo");
			grdData.DataSource = dt;
		}
		private void btnNew_Click(object sender, EventArgs e)
		{
			frmConfigShipToDetailH frm = new frmConfigShipToDetailH();
