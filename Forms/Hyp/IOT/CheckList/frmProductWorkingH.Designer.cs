namespace BMS
{
    partial class frmProductWorkingH
    {
        /// <summary>
        ...
        {
			System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(frmProductWorkingH));
			...
			this.colActionTypes = new DevExpress.XtraGrid.Columns.GridColumn();
			this.colIsApproveds = new DevExpress.XtraGrid.Columns.GridColumn();
			...
			this.colPeriodValueNew = new DevExpress.XtraGrid.Columns.GridColumn();
			this.colMinValueNew = new DevExpress.XtraGrid.Columns.GridColumn();
			this.colMaxValueNew = new DevExpress.XtraGrid.Columns.GridColumn();
			...
			this.colWorkingName.VisibleIndex = 4;
			...
			this.colValueTypeName.VisibleIndex = 5;
			...
			this.colCheckValueType.AppearanceHeader.BackColor = System.Drawing.Color.FromArgb(((int)(((byte)(224)))), ((int)(((byte)(224)))), ((int)(((byte)(224)))));
			...
			this.colCheckValueType.AppearanceHeader.Options.UseBackColor = true;
			...
			this.colCheckValueType.VisibleIndex = 6;
			// 
			// colValue
			// 
			...
			// colActionTypes
			// 
			this.colActionTypes.AppearanceCell.Options.UseTextOptions = true;
			this.colActionTypes.AppearanceCell.TextOptions.HAlignment = DevExpress.Utils.HorzAlignment.Center;
			this.colActionTypes.AppearanceCell.TextOptions.VAlignment = DevExpress.Utils.VertAlignment.Center;
			this.colActionTypes.AppearanceCell.TextOptions.WordWrap = DevExpress.Utils.WordWrap.Wrap;
			this.colActionTypes.AppearanceHeader.BackColor = System.Drawing.Color.FromArgb(((int)(((byte)(224)))), ((int)(((byte)(224)))), ((int)(((byte)(224)))));
			this.colActionTypes.AppearanceHeader.Font = new System.Drawing.Font("Tahoma", 8.25F, System.Drawing.FontStyle.Bold);
			this.colActionTypes.AppearanceHeader.Options.UseBackColor = true;
			this.colActionTypes.AppearanceHeader.Options.UseFont = true;
			this.colActionTypes.AppearanceHeader.Options.UseTextOptions = true;
			this.colActionTypes.AppearanceHeader.TextOptions.HAlignment = DevExpress.Utils.HorzAlignment.Center;
			this.colActionTypes.AppearanceHeader.TextOptions.WordWrap = DevExpress.Utils.WordWrap.Wrap;
			this.colActionTypes.Caption = "Hành động";
			this.colActionTypes.FieldName = "ActionTypes";
			this.colActionTypes.Name = "colActionTypes";
			this.colActionTypes.Visible = true;
			this.colActionTypes.VisibleIndex = 1;
			this.colActionTypes.Width = 90;
			// 
			// colIsApproveds
			// 
			this.colIsApproveds.AppearanceCell.Options.UseTextOptions = true;
			this.colIsApproveds.AppearanceCell.TextOptions.HAlignment = DevExpress.Utils.HorzAlignment.Center;
			this.colIsApproveds.AppearanceCell.TextOptions.VAlignment = DevExpress.Utils.VertAlignment.Center;
			this.colIsApproveds.AppearanceCell.TextOptions.WordWrap = DevExpress.Utils.WordWrap.Wrap;
			this.colIsApproveds.AppearanceHeader.BackColor = System.Drawing.Color.FromArgb(((int)(((byte)(224)))), ((int)(((byte)(224)))), ((int)(((byte)(224)))));
			this.colIsApproveds.AppearanceHeader.Font = new System.Drawing.Font("Tahoma", 8.25F, System.Drawing.FontStyle.Bold);
			this.colIsApproveds.AppearanceHeader.Options.UseBackColor = true;
			this.colIsApproveds.AppearanceHeader.Options.UseFont = true;
			this.colIsApproveds.AppearanceHeader.Options.UseTextOptions = true;
			this.colIsApproveds.AppearanceHeader.TextOptions.HAlignment = DevExpress.Utils.HorzAlignment.Center;
			this.colIsApproveds.AppearanceHeader.TextOptions.WordWrap = DevExpress.Utils.WordWrap.Wrap;
			this.colIsApproveds.Caption = "Trạng thái";
			this.colIsApproveds.FieldName = "IsApproveds";
			this.colIsApproveds.Name = "colIsApproveds";
			this.colIsApproveds.Visible = true;
			this.colIsApproveds.VisibleIndex = 0;
			this.colIsApproveds.Width = 105;
			// 
			// colIsApproved
			// 
			this.colIsApproved.AppearanceHeader.BackColor = System.Drawing.Color.FromArgb(((int)(((byte)(224)))), ((int)(((byte)(224)))), ((int)(((byte)(224)))));
			this.colIsApproved.AppearanceHeader.Options.UseBackColor = true;
			this.colIsApproved.Caption = "IsApproved";
			this.colIsApproved.FieldName = "IsApproved";
			this.colIsApproved.Name = "colIsApproved";
			// 
			// colSortOrders
			// 
			this.colSortOrders.AppearanceHeader.BackColor = System.Drawing.Color.FromArgb(((int)(((byte)(224)))), ((int)(((byte)(224)))), ((int)(((byte)(224)))));
			this.colSortOrders.AppearanceHeader.Options.UseBackColor = true;
			...
			// colActionType
			// 
			this.colActionType.AppearanceHeader.BackColor = System.Drawing.Color.FromArgb(((int)(((byte)(224)))), ((int)(((byte)(224)))), ((int)(((byte)(224)))));
			this.colActionType.AppearanceHeader.Options.UseBackColor = true;
			this.colActionType.Caption = "ActionType";
			this.colActionType.FieldName = "ActionType";
			this.colActionType.Name = "colActionType";
			// 
			// colPeriodValueNew
			// 
			this.colPeriodValueNew.AppearanceHeader.BackColor = System.Drawing.Color.FromArgb(((int)(((byte)(224)))), ((int)(((byte)(224)))), ((int)(((byte)(224)))));
			this.colPeriodValueNew.AppearanceHeader.Font = new System.Drawing.Font("Tahoma", 8.25F, System.Drawing.FontStyle.Bold);
			this.colPeriodValueNew.AppearanceHeader.Options.UseBackColor = true;
			this.colPeriodValueNew.AppearanceHeader.Options.UseFont = true;
			this.colPeriodValueNew.AppearanceHeader.Options.UseTextOptions = true;
			this.colPeriodValueNew.AppearanceHeader.TextOptions.HAlignment = DevExpress.Utils.HorzAlignment.Center;
			this.colPeriodValueNew.AppearanceHeader.TextOptions.VAlignment = DevExpress.Utils.VertAlignment.Center;
			this.colPeriodValueNew.AppearanceHeader.TextOptions.WordWrap = DevExpress.Utils.WordWrap.Wrap;
			this.colPeriodValueNew.Caption = "Giá trị tiêu chuẩn mới";
			this.colPeriodValueNew.FieldName = "PeriodValueNew";
			this.colPeriodValueNew.Name = "colPeriodValueNew";
			this.colPeriodValueNew.Visible = true;
			this.colPeriodValueNew.VisibleIndex = 8;
			this.colPeriodValueNew.Width = 141;
			// 
			// colMinValueNew
			// 
			this.colMinValueNew.AppearanceCell.Options.UseTextOptions = true;
			this.colMinValueNew.AppearanceCell.TextOptions.HAlignment = DevExpress.Utils.HorzAlignment.Center;
			this.colMinValueNew.AppearanceCell.TextOptions.VAlignment = DevExpress.Utils.VertAlignment.Center;
			this.colMinValueNew.AppearanceCell.TextOptions.WordWrap = DevExpress.Utils.WordWrap.Wrap;
			this.colMinValueNew.AppearanceHeader.BackColor = System.Drawing.Color.FromArgb(((int)(((byte)(224)))), ((int)(((byte)(224)))), ((int)(((byte)(224)))));
			this.colMinValueNew.AppearanceHeader.Font = new System.Drawing.Font("Tahoma", 8.25F, System.Drawing.FontStyle.Bold);
			this.colMinValueNew.AppearanceHeader.Options.UseBackColor = true;
			this.colMinValueNew.AppearanceHeader.Options.UseFont = true;
			this.colMinValueNew.AppearanceHeader.Options.UseTextOptions = true;
			this.colMinValueNew.AppearanceHeader.TextOptions.HAlignment = DevExpress.Utils.HorzAlignment.Center;
			this.colMinValueNew.AppearanceHeader.TextOptions.VAlignment = DevExpress.Utils.VertAlignment.Center;
			this.colMinValueNew.AppearanceHeader.TextOptions.WordWrap = DevExpress.Utils.WordWrap.Wrap;
			this.colMinValueNew.Caption = "Min mới";
			this.colMinValueNew.FieldName = "MinValueNew";
			this.colMinValueNew.Name = "colMinValueNew";
			this.colMinValueNew.Visible = true;
			this.colMinValueNew.VisibleIndex = 9;
			// 
			// colMaxValueNew
			// 
			this.colMaxValueNew.AppearanceCell.Options.UseTextOptions = true;
			this.colMaxValueNew.AppearanceCell.TextOptions.HAlignment = DevExpress.Utils.HorzAlignment.Center;
			this.colMaxValueNew.AppearanceCell.TextOptions.VAlignment = DevExpress.Utils.VertAlignment.Center;
			this.colMaxValueNew.AppearanceCell.TextOptions.WordWrap = DevExpress.Utils.WordWrap.Wrap;
			this.colMaxValueNew.AppearanceHeader.BackColor = System.Drawing.Color.FromArgb(((int)(((byte)(224)))), ((int)(((byte)(224)))), ((int)(((byte)(224)))));
			this.colMaxValueNew.AppearanceHeader.Font = new System.Drawing.Font("Tahoma", 8.25F, System.Drawing.FontStyle.Bold);
			this.colMaxValueNew.AppearanceHeader.Options.UseBackColor = true;
			this.colMaxValueNew.AppearanceHeader.Options.UseFont = true;
			this.colMaxValueNew.AppearanceHeader.Options.UseTextOptions = true;
			this.colMaxValueNew.AppearanceHeader.TextOptions.HAlignment = DevExpress.Utils.HorzAlignment.Center;
			this.colMaxValueNew.AppearanceHeader.TextOptions.VAlignment = DevExpress.Utils.VertAlignment.Center;
			this.colMaxValueNew.AppearanceHeader.TextOptions.WordWrap = DevExpress.Utils.WordWrap.Wrap;
			this.colMaxValueNew.Caption = "Max mới";
			this.colMaxValueNew.FieldName = "MaxValueNew";
			this.colMaxValueNew.Name = "colMaxValueNew";
			this.colMaxValueNew.Visible = true;
			this.colMaxValueNew.VisibleIndex = 10;
			// 
			// colIsHidden
			// 
			...
			this.Name = "frmProductWorkingH";
			this.Text = "DANH SÁCH MỤC KIỂM TRA THEO SẢN PHẨM HYPONIC";
        ...
        private DevExpress.XtraGrid.Columns.GridColumn colActionTypes;
        private DevExpress.XtraGrid.Columns.GridColumn colIsApproveds;
        ...
        private DevExpress.XtraGrid.Columns.GridColumn colPeriodValueNew;
        private DevExpress.XtraGrid.Columns.GridColumn colMinValueNew;
        private DevExpress.XtraGrid.Columns.GridColumn colMaxValueNew;
