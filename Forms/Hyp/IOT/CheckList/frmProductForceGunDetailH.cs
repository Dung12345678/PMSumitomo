...
namespace BMS
{
    public partial class frmProductForceGunDetailH : _Forms
    {
        public ProductCheckForceModel model = new ProductCheckForceModel();

        public frmProductForceGunDetailH()
        {
            InitializeComponent();
        }
        /// <summary>
        ...
        private void setTextBaseProductCode(string ProductCode)
        {
            ...
            txtProductTypeCode.Text = TextUtils.ToString(dt.Rows[0]["ProductTypeCode"]);
