...
namespace BMS
{
    public partial class frmProductForceGunH : _Forms
    {
        public frmProductForceGunH()
        {
            InitializeComponent();
        }
        ...
        private void btnAdd_Click(object sender, EventArgs e)
        {
            ...
            frmProductForceGunDetailH frm = new frmProductForceGunDetailH();
        ...
        private void btnEdit_Click(object sender, EventArgs e)
        {
            ...
            ProductModel productModel = arrProduct[0] as ProductModel;
            frmProductForceGunDetailH frm = new frmProductForceGunDetailH();
            frm.model = model;
            if (frm.ShowDialog() == DialogResult.OK)
            {
        ...
        {
            frmProductForceGunExcelH frm = new frmProductForceGunExcelH();
            frm.ShowDialog();
            LoadInfoSearch();
        }
    }
