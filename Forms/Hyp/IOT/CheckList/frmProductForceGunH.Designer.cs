namespace BMS
{
    partial class frmProductForceGunH
    {
        /// <summary>
        ...
        {
			System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(frmProductForceGunH));
			...
			this.colForceRange = new DevExpress.XtraGrid.Columns.GridColumn();
			...
			this.colQtyBuLong = new DevExpress.XtraGrid.Columns.GridColumn();
			this.colBanGa = new DevExpress.XtraGrid.Columns.GridColumn();
			this.colBanThat = new DevExpress.XtraGrid.Columns.GridColumn();
			...
			this.btnImportExcel.Tag = "frmProduct_GunH";
			...
			this.btnDel.Tag = "frmProduct_GunH";
			...
			this.btnEdit.Tag = "frmProduct_GunH";
			...
			this.btnAdd.Tag = "frmProduct_GunH";
			...
			this.btnExcel.Tag = "frmProduct_GunH";
			...
			this.colProductCode.Caption = "PRODUCTID";
			...
			this.colDescription.FieldName = "ProductName";
			...
			this.colProductGroupCode.VisibleIndex = 1;
			this.colProductGroupCode.Width = 119;
			// 
			// colForceRange
			// 
			this.colForceRange.AppearanceCell.Options.UseTextOptions = true;
			this.colForceRange.AppearanceCell.TextOptions.VAlignment = DevExpress.Utils.VertAlignment.Center;
			this.colForceRange.AppearanceHeader.Font = new System.Drawing.Font("Tahoma", 8.25F, System.Drawing.FontStyle.Bold);
			this.colForceRange.AppearanceHeader.Options.UseFont = true;
			this.colForceRange.AppearanceHeader.Options.UseTextOptions = true;
			this.colForceRange.AppearanceHeader.TextOptions.HAlignment = DevExpress.Utils.HorzAlignment.Center;
			this.colForceRange.AppearanceHeader.TextOptions.WordWrap = DevExpress.Utils.WordWrap.Wrap;
			this.colForceRange.Caption = "LỰC CHECK 1";
			this.colForceRange.DisplayFormat.FormatString = "{0:0.0}";
			this.colForceRange.DisplayFormat.FormatType = DevExpress.Utils.FormatType.Numeric;
			this.colForceRange.FieldName = "LucCheck1";
			this.colForceRange.Name = "colForceRange";
			this.colForceRange.OptionsColumn.AllowEdit = false;
			this.colForceRange.Visible = true;
			this.colForceRange.VisibleIndex = 4;
			this.colForceRange.Width = 120;
			// 
			// colGunNumber
			// 
			...
			this.colGunNumber.VisibleIndex = 5;
			this.colGunNumber.Width = 71;
			// 
			// colID
			// 
			...
			this.colJobNumber.VisibleIndex = 6;
			this.colJobNumber.Width = 73;
			// 
			// colProductStepCode
			// 
			this.colProductStepCode.AppearanceCell.Options.UseTextOptions = true;
			this.colProductStepCode.AppearanceCell.TextOptions.VAlignment = DevExpress.Utils.VertAlignment.Center;
			...
			this.colProductStepCode.AppearanceHeader.TextOptions.WordWrap = DevExpress.Utils.WordWrap.Wrap;
			this.colProductStepCode.Caption = "CÔNG ĐOẠN";
			...
			this.colProductStepCode.Visible = true;
			this.colProductStepCode.VisibleIndex = 12;
			this.colProductStepCode.Width = 56;
			// 
			// colShootNumber
			// 
			...
			this.colShootNumber.VisibleIndex = 8;
			// 
			// colSetForce
			// 
			...
			this.colSetForce.DisplayFormat.FormatString = "{0:0.0}";
			this.colSetForce.DisplayFormat.FormatType = DevExpress.Utils.FormatType.Numeric;
			...
			this.colSetForce.VisibleIndex = 11;
			this.colSetForce.Width = 53;
			// 
			// colQtyBuLong
			// 
			this.colQtyBuLong.AppearanceCell.Options.UseTextOptions = true;
			this.colQtyBuLong.AppearanceCell.TextOptions.VAlignment = DevExpress.Utils.VertAlignment.Center;
			this.colQtyBuLong.AppearanceHeader.Font = new System.Drawing.Font("Tahoma", 8.25F, System.Drawing.FontStyle.Bold);
			this.colQtyBuLong.AppearanceHeader.Options.UseFont = true;
			this.colQtyBuLong.AppearanceHeader.Options.UseTextOptions = true;
			this.colQtyBuLong.AppearanceHeader.TextOptions.HAlignment = DevExpress.Utils.HorzAlignment.Center;
			this.colQtyBuLong.AppearanceHeader.TextOptions.WordWrap = DevExpress.Utils.WordWrap.Wrap;
			this.colQtyBuLong.Caption = "SỐ LƯỢNG BULONG";
			this.colQtyBuLong.FieldName = "QtyBuLong";
			this.colQtyBuLong.Name = "colQtyBuLong";
			this.colQtyBuLong.OptionsColumn.AllowEdit = false;
			this.colQtyBuLong.Visible = true;
			this.colQtyBuLong.VisibleIndex = 7;
			this.colQtyBuLong.Width = 74;
			// 
			// colBanGa
			// 
			this.colBanGa.AppearanceCell.Options.UseTextOptions = true;
			this.colBanGa.AppearanceCell.TextOptions.VAlignment = DevExpress.Utils.VertAlignment.Center;
			this.colBanGa.AppearanceCell.TextOptions.WordWrap = DevExpress.Utils.WordWrap.Wrap;
			this.colBanGa.AppearanceHeader.Font = new System.Drawing.Font("Tahoma", 8.25F, System.Drawing.FontStyle.Bold);
			this.colBanGa.AppearanceHeader.Options.UseFont = true;
			this.colBanGa.AppearanceHeader.Options.UseTextOptions = true;
			this.colBanGa.AppearanceHeader.TextOptions.HAlignment = DevExpress.Utils.HorzAlignment.Center;
			this.colBanGa.AppearanceHeader.TextOptions.WordWrap = DevExpress.Utils.WordWrap.Wrap;
			this.colBanGa.Caption = "BẮN GÁ";
			this.colBanGa.ColumnEdit = this.repositoryItemMemoEdit1;
			this.colBanGa.FieldName = "QtyOcBanGa";
			this.colBanGa.Name = "colBanGa";
			this.colBanGa.OptionsColumn.AllowEdit = false;
			this.colBanGa.Visible = true;
			this.colBanGa.VisibleIndex = 9;
			this.colBanGa.Width = 62;
			// 
			// colBanThat
			// 
			this.colBanThat.AppearanceCell.Options.UseTextOptions = true;
			this.colBanThat.AppearanceCell.TextOptions.VAlignment = DevExpress.Utils.VertAlignment.Center;
			this.colBanThat.AppearanceCell.TextOptions.WordWrap = DevExpress.Utils.WordWrap.Wrap;
			this.colBanThat.AppearanceHeader.Font = new System.Drawing.Font("Tahoma", 8.25F, System.Drawing.FontStyle.Bold);
			this.colBanThat.AppearanceHeader.Options.UseFont = true;
			this.colBanThat.AppearanceHeader.Options.UseTextOptions = true;
			this.colBanThat.AppearanceHeader.TextOptions.HAlignment = DevExpress.Utils.HorzAlignment.Center;
			this.colBanThat.AppearanceHeader.TextOptions.WordWrap = DevExpress.Utils.WordWrap.Wrap;
			this.colBanThat.Caption = "BẮN THẬT";
			this.colBanThat.ColumnEdit = this.repositoryItemMemoEdit1;
			this.colBanThat.FieldName = "QtyOcBanThat";
			this.colBanThat.Name = "colBanThat";
			this.colBanThat.OptionsColumn.AllowEdit = false;
			this.colBanThat.Visible = true;
			this.colBanThat.VisibleIndex = 10;
			this.colBanThat.Width = 62;
			// 
			// colProductTypeCode
			// 
			this.colProductTypeCode.AppearanceCell.Options.HighPriority = true;
			...
			this.colProductTypeCode.Caption = "LOẠI SẢN PHẨM";
			...
			this.colProductTypeCode.Width = 91;
			// 
			// grdData
			// 
			...
			this.grdData.Size = new System.Drawing.Size(1206, 631);
			...
			this.Name = "frmProductForceGunH";
			this.Text = "QUẢN LÝ SÚNG LỰC HYPONIC";
			this.WindowState = System.Windows.Forms.FormWindowState.Maximized;
			this.Load += new System.EventHandler(this.frmProductForceGun_Load);
        ...
        private DevExpress.XtraGrid.Columns.GridColumn colForceRange;
        ...
        private DevExpress.XtraGrid.Columns.GridColumn colQtyBuLong;
        private DevExpress.XtraGrid.Columns.GridColumn colBanGa;
        private DevExpress.XtraGrid.Columns.GridColumn colBanThat;
