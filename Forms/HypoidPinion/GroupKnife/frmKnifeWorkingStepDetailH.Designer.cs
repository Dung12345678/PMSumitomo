namespace BMS
{
    partial class frmKnifeWorkingStepDetailH
    {
        /// <summary>
        ...
        private void InitializeComponent()
        {
			...
			System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(frmKnifeWorkingStepDetailH));
			...
			this.btnSave.Tag = "frmWorkingStepDetailH_Add&&Close";
			...
			this.btnSaveNew.Tag = "frmWorkingStepDetailH_Add&&New";
			...
			this.Name = "frmKnifeWorkingStepDetailH";
			this.Text = "CHI TIẾT CÔNG ĐOẠN HYPINION";
