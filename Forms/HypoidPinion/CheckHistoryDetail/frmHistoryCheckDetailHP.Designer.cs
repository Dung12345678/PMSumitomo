...
namespace BMS
{
	partial class frmHistoryCheckDetailHP
	{
		/// <summary>
		...
		{
			System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(frmHistoryCheckDetailHP));
			...
			this.colRealValue1.Caption = "Thực tế";
			this.colRealValue1.FieldName = "RealValue";
			...
			this.colRealValue2.Caption = "Thực tế";
			this.colRealValue2.FieldName = "RealValue1";
			...
			this.colRealValue3.Caption = "Thực tế";
			this.colRealValue3.FieldName = "RealValue2";
			...
			this.colRealValue4.Caption = "Thực tế";
			this.colRealValue4.FieldName = "RealValue3";
			...
			this.colRealValue5.Caption = "Thực tế";
			this.colRealValue5.FieldName = "RealValue4";
			...
			this.Name = "frmHistoryCheckDetailHP";
			this.Text = "CHI TIẾT KIỂM TRA DỤNG CỤ";
